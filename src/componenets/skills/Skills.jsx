...
function Skills() {
  const skills = [
    ...
    {
      title: "Framework",
      content: ["Node.js", "Express.js", "Vue.js", "Django", "React", "Angular", "Bootstrap", "Sass"]
    },
    {
      title: "Developer Tools",
      content: ["Linux", "Git", "AWS", "Azure", "REST API", "MongoDB", "MySQL", "ArangoDB", "Docker", "Jenkins", "Wordpress"]
    },
    {
      title: "Testing tools",
