...
function Item({ item }) {
    ...
    let demo
    if (item.demo_link) {
        demo = <div className="projectItem__pair">
            <div className="projectItem__key">
                Demo:
            </div>
            <div className="projectItem__content">
                <a href={item.demo_link} className='projectItem__ref' target="_blank" rel="noopener noreferrer">
                    See demo
                </a>
            </div>
        </div>
    ...
    let source
    if (item.source_code_link) {
        source = <div className="projectItem__pair">
            <div className="projectItem__key">
                Source code:
            </div>
            <div className="projectItem__content">
                <a href={item.source_code_link} className='projectItem__ref' target="_blank" rel="noopener noreferrer">
                    See souce code
                </a>
            </div>
        </div>
